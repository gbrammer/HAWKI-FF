...
\Abstract{The \textit{HST} Frontier Fields (HFF) programme is a multi-cycle campaign 
...
propose to continue our P92 \textit{VLT} legacy programme and image the year 3 (2015) Frontier Fields in the $K_s$-band 
with HAWK-I down to $K_s=26.5$ (AB, 5$\sigma$).  The $K_s$ band at 2.2\,$\mu\mathrm{m}$ crucially fills the gap between 
...
total magnitude limit of H$_{\rm 160}$=28.7 AB mag. Furthermore, the HFF are being observed 
...
of redshifts in two Frontier Fields clusters we observed with HAWK-I in P92: we 
...
galaxies detected in the deeper \textit{HST} imaging with robust upper limits in 
$K_s$).}
...
$z$$\sim$4 but only the most massive galaxies are accessible at the existing survey 
...
wavelengths avoiding confusion challenges of the redder IRAC bands. Combined with the HFF fields we observed in P92, the 
...
fields, as demonstrated by our P92 programme \texttt{\small (http://gbrammer.github.io/HAWKI-FF/)}.
...
Frontier Fields. Our experience with the P92 allocation of HAWK-I imaging of 
...
HAWK-I (Bouwens et al. 2013), now over a significantly larger survey area ($\sim$225 arcmin$^2$ over both P92 and P95, as proposed here). }


\ModeJustification{The HAWK-I observations we propose are straightforward imaging acquisitions of large survey fields, and the full integrations that require very good and uniform image quality can be most efficiently scheduled in Service Mode throughout P95.  We do not have specific timing constraints, so the observations can be easily scheduled around the AOF-related activities at UT4.}
