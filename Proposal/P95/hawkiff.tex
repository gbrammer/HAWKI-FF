...
\Title{Ultra-Deep $K_s$-band imaging of the \textit{HST} Frontier Fields Year 2 Cluters}  
...
propose a \textit{VLT} legacy program to image the Year 2 Frontier Fields in the $K_s$-band 
...
\ImmediateObjective{Immediate objective of the proposal: state what is
  ...
  In the case of VLT-XMM programmes please also specify the immediate
  objectives of the XMM observations. } 
