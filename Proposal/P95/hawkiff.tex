...
spectroscopic follow-up. The HFF will image 12 times the area of the HUDF (total surveyed 
...
content and/or metallicity) of the first galaxies [6].
...
fields, as demonstrated by our P92 program \texttt{\small [http://github.com/gbrammer/HAWKI-FF]}.
...
\textbf{092.A-0472}, ``Ultra-Deep $K_s$-band imaging of the \textit{HST} Frontier Fields'', 82 h, HAWK-I.  This program observed the first two FF clusters, with observations completed in Feb 2014; see Figs. 1 \& 2.  The images have been reduced and the mosaics are made freely available to the community \texttt{\small [http://github.com/gbrammer/HAWKI-FF]}.  The images will be submitted to ESO as a Phase 3 data product in Fall 2014, and a survey description paper is in preparation.
