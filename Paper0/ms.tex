...
\tablehead{ 
\colhead{Field} & \colhead{R.A.} & \colhead{Dec.} & \colhead{Instrument} & \colhead{Epoch} & \textit{HST}\footnotemark[1] & \colhead{$t$, hours} & \colhead{Depth\footnotemark[2]} & \colhead{FWHM}}
\startdata 
...
\vspace {-0.3cm}\\ 
&  &         & \textit{VLT}/HAWKI\footnotemark[3]     & 2013 Mar 21--2014 Jun 9      & C & 5.3 & 25.0 & $0\farcs41$
\enddata 
%\vspace{-0.8cm} 
